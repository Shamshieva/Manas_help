            ...
            <div class="card-body"  style="width: 60%; margin: 0 auto; ">
                ...
                <form action="{{ route('auth.register') }}" method="post">
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text" class="form-control" id="name" name="name" style=" border: 2px solid #3498db; background-color: #ecf0f1; color: #2c3e50;" required="">
                        @error('name')
                    ...
                    <div class="form-group" >
                        ...
                        <input type="email" class="form-control" id="email" name="email" style=" border: 2px solid #3498db; background-color: #ecf0f1; color: #2c3e50;" required>
                        @error('email')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="form-group" >
                        ...
                        <input type="password" class="form-control" id="pwd" style=" border: 2px solid #3498db; background-color: #ecf0f1; color: #2c3e50;" name="password" required>
                        @error('password')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
{{--                    <input type="hidden" name="role" value="{{ \App\Models\User::ROLE_READER }}">--}}
                ...
                <p style="text-align: center; margin-top: 10px;">Do you already have an account? <a href="{{ route('auth.login') }}">Sign in here</a></p>
            </div>
