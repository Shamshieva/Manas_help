    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.subcategory.store.video',$subcategory->id)}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating mb-3">
                                <label for="description_ky">description_ky</label>
                                <textarea class="form-control" placeholder="description_ky" id="description_ky"
                                          name="description_ky"></textarea>
                            </div>
                            @error('description_ky')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
