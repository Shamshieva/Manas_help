...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user_files/assets/css/style.css') }}">
    <script src="{{ asset('user_files/assets/vendors/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('user_files/assets/js/loader.js') }}"></script>
</head>
<body>
        ...
        <div class="row footer-widget-area">
            <div class="col-md-3">
                <a href="index.html" class="footer-brand-wrapper">
                    <img src="{{ asset('user_files/assets/images/logo.svg') }}" alt="edica logo">
                </a>
...
<script src="{{ asset('user_files/assets/vendors/popper.js/popper.min.js') }}"></script>
<script src="{{ asset('user_files/assets/vendors/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('user_files/assets/vendors/aos/aos.js') }}"></script>
<script src="{{ asset('user_files/assets/js/main.js') }}"></script>
<script>
    AOS.init({
        duration: 1000
    });
